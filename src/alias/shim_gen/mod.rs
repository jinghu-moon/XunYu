...
pub use sync::{
    app_alias_to_sync_entry, app_alias_to_sync_entry_with_gui, app_alias_uses_gui_template,
    config_to_sync_entries, remove_shim, shell_alias_to_sync_entry, sync_all, sync_app_alias,
    sync_entries, sync_shell_alias,
};
