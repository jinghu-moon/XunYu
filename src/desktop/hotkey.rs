use windows_sys::Win32::UI::Input::KeyboardAndMouse::{
    ...
    VK_BACK, VK_CAPITAL, VK_DELETE, VK_END, VK_ESCAPE, VK_F1, VK_F10, VK_F11, VK_F12, VK_F2,
    VK_F3, VK_F4, VK_F5, VK_F6, VK_F7, VK_F8, VK_F9, VK_HOME, VK_INSERT, VK_LEFT, VK_NEXT,
    VK_NUMLOCK, VK_OEM_1, VK_OEM_2, VK_OEM_3, VK_OEM_4, VK_OEM_5, VK_OEM_6, VK_OEM_7,
    VK_OEM_COMMA, VK_OEM_MINUS, VK_OEM_PERIOD, VK_OEM_PLUS, VK_PAUSE, VK_PRIOR, VK_RETURN,
    VK_RIGHT, VK_SCROLL, VK_SNAPSHOT, VK_SPACE, VK_TAB, VK_UP, VK_DOWN,
};
...
pub(crate) fn str_to_vk(s: &str) -> Option<u32> {
    let result = match s {
        ...
        "home" => VK_HOME, "end" => VK_END, "pgup" | "pageup" => VK_PRIOR,
        "pgdn" | "pagedown" => VK_NEXT, "ins" | "insert" => VK_INSERT,
        "del" | "delete" => VK_DELETE, "space" => VK_SPACE,
        "enter" | "return" => VK_RETURN, "tab" => VK_TAB,
        "esc" | "escape" => VK_ESCAPE, "backspace" => VK_BACK,
        "capslock" => VK_CAPITAL, "pause" => VK_PAUSE,
        "printscreen" => VK_SNAPSHOT, "scrolllock" => VK_SCROLL,
        "numlock" => VK_NUMLOCK, ";" | "semicolon" => VK_OEM_1,
        "=" | "equals" => VK_OEM_PLUS, "," | "comma" => VK_OEM_COMMA,
        "-" | "minus" => VK_OEM_MINUS, "." | "period" => VK_OEM_PERIOD,
        "/" | "slash" => VK_OEM_2, "`" | "backtick" => VK_OEM_3,
        "[" | "leftbracket" => VK_OEM_4, "\\" | "backslash" => VK_OEM_5,
