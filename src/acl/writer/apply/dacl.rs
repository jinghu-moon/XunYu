...
use windows::Win32::Security::{ACL, DACL_SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, PSID};
use windows::core::{PCWSTR, PWSTR};

use crate::acl::error::AclError;
use crate::acl::reader::{AceHeaderPublic, sid_to_string};
...
pub(super) fn remove_rules(path: &Path, to_remove: &[AceEntry]) -> Result<usize> {
    ...
    unsafe {
        ...
        for i in (0..count).rev() {
            ...
            let header = &*(ace_ptr as *const AceHeaderPublic);
