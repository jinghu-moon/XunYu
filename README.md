...
- Dashboard 工作台：Home、Bookmarks、Ports、Proxy、Config、Env、Redirect、Audit；若启用 `diff`，还会打开文件浏览、转换、校验与 Diff 可视化能力
...
- Dashboard 入口：`intro/dashboard/Dashboard-Components.md`
